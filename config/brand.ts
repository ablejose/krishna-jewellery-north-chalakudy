...
export const BRAND: BrandConfig = {
  ...
  description:
    "Krishna Jewellery is Chalakudy's trusted destination for exquisite gold, diamond, and silver jewellery. Serving Chalakudy and the surrounding areas with timeless craftsmanship and contemporary designs for every celebration.",
  ...
  mapsLink:
    "https://www.google.com/maps/search/?api=1&query=Krishna%20Jewellery&query_place_id=ChIJBU3S-GoCCDsR4OfxK9gMbRw",
  ...
  seo: {
    title: "Krishna Jewellery | Jewellery in Chalakudy",
    description:
      "Krishna Jewellery — your premier jewellery store in Chalakudy. Gold, diamond and silver jewellery crafted for every occasion. Visit us in Chalakudy, Kerala.",
    keywords: [
      "Krishna Jewellery",
      "jewellery Chalakudy",
    ...
    canonical: "https://krishna-jewellery-north-chalakudy.vercel.app",
    ogImage:
      "/images/store1.webp",
  },
  ...
  whatsappMessage:
    "Hello Krishna Jewellery, I'd like to know more about your jewellery collections.",
};
